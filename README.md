# Authentication-Secrets-App in order to run the app run the npm i command in the terminal, when the installation is finished run the nodemon app.js command in the terminal.
